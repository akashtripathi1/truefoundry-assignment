...
const LogHeader = () => {
  ...
  const formattedStartTime = formatDateTime(startTime);
    ...
    return (
        ...
        <div className="metrics-header" style={{display: 'flex', alignItems: 'center', justifyContent: 'flex-end'}}>
            <p style={{display: 'inline-block', marginRight: '10px', marginBottom: '5px', padding: '0'}}>Showing Logs for {formattedStartTime} {String.fromCharCode(8594)}</p>
